...
public class InvestmentDetailsServiceImpl implements InvestmentDetailsServiceInf {
    ...
    @Override
    public List<InvestmentDetails> selectByConditionForPage(InvestmentDetails reportInvestment, PageWhere pageWhere, String searchDateSt, String searchDateEnd) {
        return investmentDetailsDao.selectByConditionForPage(reportInvestment,pageWhere,searchDateSt,searchDateEnd);
    }
    @Override
    ...
    public List<InvestmentDetails> getId(String indBpNumber) {
        return investmentDetailsDao.getId(indBpNumber);
    }
}
