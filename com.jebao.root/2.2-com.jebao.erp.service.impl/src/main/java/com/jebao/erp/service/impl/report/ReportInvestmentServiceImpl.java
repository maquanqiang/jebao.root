...
public class ReportInvestmentServiceImpl implements ReportInvestmentServiceInf {
     ...
     */
    @Override
    public List<ReportInvestment> selectByConditionForPage(ReportInvestment reportInvestment,PageWhere pageWhere) {
      List<ReportInvestment> list = reportInvestmentDao.selectByConditionForPage(reportInvestment,pageWhere);
        return list;
    }
