...
var vm = new Vue({
    ...
    methods: {
        search:function(event,liCreateTime,bpRepayTime){
             ...
             if((model.searchObj.searchDateSt!=null && model.searchObj.searchDateSt!= "")
                                  ...
                                  $.get("/api/report/betweenDate",{li_create_time:liCreateTime,bp_repay_time:bpRepayTime},function(response){
                                        alert("fefe");

                                        if(response.success_is_ok){
                                            alert(response.count+"fef");
