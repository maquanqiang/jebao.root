package com.jebao.erp.web.responseModel.account;
 ...
 */
public class AccountCountVM extends ViewModel {


    public AccountCountVM(AccountCount count){
        this.createCount = count.getCreateCount();
        this.loginCount = count.getLoginCount();
        this.nonCheckCount = count.getNonCheckCount();
        this.yesterdayCount = count.getYesterdayCount();
        this.planTotal = count.getPlanTotal();
        this.yesterdayLoan = count.getYesterdayLoan();
        this.loanTotal = count.getLoanTotal();
        this.yesterdayWithdraw = count.getYesterdayWithdraw();
        this.withdrawCount = count.getWithdrawCount();
        this.investCount = count.getInvestCount();
        this.yesterdayIncome = count.getYesterdayIncome();
    }
