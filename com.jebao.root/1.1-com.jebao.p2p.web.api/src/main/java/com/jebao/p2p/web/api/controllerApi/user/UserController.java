    ...
    private void fuiouRechargeNotify(FuiouRechargeForm form) {
        ...
        if(rechargeResult.isFlag()){
            ...
            if(tbFundsDetailses!=null && tbFundsDetailses.size()>0){
                ...
                if(tbFundsDetails.getFdSerialStatus() != 1){
                    rechargeService.fuiouRechargeNotify(userLoginInfo.getLiId(),reqData,rechargeResult.getXmlResp(),tbFundsDetails);
                }
            }else{
                rechargeService.fuiouRechargeNotify(userLoginInfo.getLiId(),reqData,rechargeResult.getXmlResp(),null);
            }
        }
