...
public class ProductDetailVM extends ViewModel {
    ...
    public ProductDetailVM(TbBidPlan entity){
        ...
        this.bpSurplusMoney = entity.getBpStatus() ==  7? new BigDecimal(0) : entity.getBpSurplusMoney();
        ...
        this.bpMonthTerm = entity.getBpMonthTerm();
        this.progress=(entity.getBpBidMoney().subtract( entity.getBpStatus() ==  7? new BigDecimal(0) :entity.getBpSurplusMoney())).multiply(new BigDecimal(100)).
