...
import com.jebao.thirdPay.fuiou.model.balanceAction.ResponsePlainResult;
 ...
 */
public class QueryTxnPlain extends BasePlain {
    private String busi_tp="";
    private String total_number="";
    @XmlElementWrapper(name="results")
    @XmlElement(name="result")
    List<QueryTxnPlainResult> results=new ArrayList<QueryTxnPlainResult>();
