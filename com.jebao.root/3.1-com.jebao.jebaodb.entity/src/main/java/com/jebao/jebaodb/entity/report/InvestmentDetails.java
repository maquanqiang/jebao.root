...
public class InvestmentDetails {
    //通过当前的信息来指定输出的内容
    public static InvestmentDetailsSM entity(InvestmentDetails investmentDetails){
        InvestmentDetailsSM investmentDetailsSM = new InvestmentDetailsSM();
        investmentDetailsSM.setBpInterestPayType(investmentDetails.getBpInterestPayType());
        investmentDetailsSM.setBpInterestSt(investmentDetails.getBpInterestSt());
        investmentDetailsSM.setBpNumber(investmentDetails.getBpNumber());
        investmentDetailsSM.setBpPeriods(investmentDetails.getBpPeriods());
        investmentDetailsSM.setBpRate(investmentDetails.getBpRate());
        investmentDetailsSM.setFoldMoney(investmentDetails.getFoldMoney());
        investmentDetailsSM.setBpRepayTime(investmentDetails.getBpRepayTime());
        investmentDetailsSM.setIiMoney(investmentDetails.getIiMoney());
        investmentDetailsSM.setIndTrueName(investmentDetails.getIndTrueName());
        investmentDetailsSM.setLiLoginName(investmentDetails.getLiLoginName());
        investmentDetailsSM.setLiCreateTime(investmentDetails.getLiCreateTime());
        //投资期限
        investmentDetailsSM.setIndMoney(investmentDetails.getIndMoney());
        investmentDetailsSM.setBpCycleType(investmentDetails.getBpCycleType());
        investmentDetailsSM.setSearchDateSt(investmentDetails.getSearchDateSt());
        investmentDetailsSM.setSearchDateEnd(investmentDetails.getSearchDateEnd());
        return investmentDetailsSM;
    }
    //投资期限
